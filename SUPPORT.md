...
Use the right channel for the kind of help you need. Public GitHub threads must never contain credentials, customer information, sensitive prompts, or regulated data.
...
When seeking help, include the smallest non-sensitive reproduction, the relevant component, the version or commit, environment details, and the checks already attempted. Redact logs and configuration before sharing them.
