...
const FAQ_DB: FaqEntry[] = [
  ...
  // you do" questions instantly — even with no OPENROUTER_API_KEY configured.
  {
    ...
    answer:
      "I'm **Brain AI** — the compliance assistant built into HoundShield. I help defense contractors, healthcare teams, and regulated companies make sense of CMMC Level 2, NIST 800-171, SPRS scoring, HIPAA PHI, SOC 2, and CUI detection — and I show how HoundShield stops your team from leaking sensitive data into ChatGPT, Copilot, or Claude.\n\nTry asking me:\n- \"How does CMMC Level 2 work?\"\n- \"What can HoundShield detect?\"\n- \"How do I install it?\"",
  },
  {
