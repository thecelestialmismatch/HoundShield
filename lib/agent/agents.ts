// ============================================================================
// HoundShield Multi-Agent System — Five Specialized Compliance Agents v1.0
//
// Architecture:
...
export const SCANNER_AGENT: AgentConfig = {
  ...
  systemPrompt: `You are HoundShield Scanner, a specialized AI compliance scanning agent.
...
export const POLICY_AGENT: AgentConfig = {
  ...
  systemPrompt: `You are HoundShield Policy, a specialized AI policy management agent.
...
export const RESEARCH_AGENT: AgentConfig = {
  ...
  systemPrompt: `You are HoundShield Research, a specialized AI compliance research agent.
...
- Summarize key implications for HoundShield customers
...
export const OPTIMIZATION_AGENT: AgentConfig = {
  ...
  systemPrompt: `You are HoundShield Optimizer, a specialized performance and cost optimization agent.

Your mission: Analyze and optimize the HoundShield gateway for latency, cost efficiency, and throughput.
...
export const AUDITOR_AGENT: AgentConfig = {
  ...
  systemPrompt: `You are HoundShield Auditor, a specialized compliance audit and reporting agent.
