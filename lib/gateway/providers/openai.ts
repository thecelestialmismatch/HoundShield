/**
 * HoundShield Streaming Gateway — OpenAI Provider Adapter
 *
 ...
 *   data: [DONE]
 *
 * The adapter normalizes this into HoundShield `StreamToken` objects, handling:
...
export const openaiAdapter: ProviderAdapter = {
   ...
   * contains token counts — this powers HoundShield usage dashboards without
