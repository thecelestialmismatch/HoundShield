                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="glass-card p-5 min-h-[400px] flex flex-col">
                                ...
                                {scanComplete && results.length > 0 && (
                                    <div className="space-y-3 flex-1 overflow-y-auto">
                                        ...
                                        <p className="text-xs text-slate-400 mb-2">Click each threat to see impact, fix tips, and why you need HoundShield Pro ↓</p>
                                        ...
                                        <div className="mt-4 p-4 rounded-xl bg-gradient-to-br from-brand-500/15 to-[rgba(129,166,198,0.15)] border border-brand-500/25">
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <p className="text-sm font-bold text-white">HoundShield Pro Package</p>
                                            </div>
                                            <p className="text-xs text-slate-500 mb-3 leading-relaxed">
                                                This free scanner shows you the problem. <strong className="text-slate-300">HoundShield Pro</strong> fixes it automatically — blocking leaks in real-time before your team&apos;s data reaches external AI providers.
                                            </p>
                    ...
                    <div className="mt-20">
                        <div className="text-center mb-10">
                            ...
                            <p className="text-sm text-slate-400 max-w-2xl mx-auto">HoundShield uses 13 AI models to detect 9 categories of sensitive data. Here&apos;s every threat pattern we check — and what makes our detection smarter than regex-only tools.</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 leading-relaxed">This free scanner uses regex patterns. <strong className="text-slate-300">HoundShield Pro</strong> uses 13 AI models that understand <em>context</em> — it knows &quot;Apple&quot; in a recipe is not the same as &quot;Apple&quot; the company. That&apos;s why you need the full package.</p>
                                </div>
                                <div>
                                    <h3 className="text-sm font-bold text-[var(--hs-success)] mb-2">6. Get the Full Package</h3>
                                    <p className="text-xs text-slate-500 leading-relaxed">Ready to protect your company? Sign up for HoundShield Pro to get real-time blocking, Slack/Teams alerts, compliance reports (SOC 2, GDPR, HIPAA), and an immutable audit trail.</p>
                                </div>
                            </div>
                        </div>
                    </div>
