  ...
  return (
    <div className="min-h-screen bg-[var(--hs-surface-0)]">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-32 pb-24">
        <h1 className="text-3xl font-semibold text-[var(--hs-ink)] mb-2" style={{ fontFamily: "var(--font-display)" }}>Privacy Policy</h1>
        <p className="text-sm text-[var(--hs-ink-tertiary)] mb-10 font-[var(--font-body)]">Last updated: March 11, 2026</p>

        <div className="space-y-8 text-sm text-[var(--hs-ink-secondary)] leading-relaxed font-[var(--font-body)]">
          <section>
            <h2 className="text-lg font-semibold text-[var(--hs-ink)] mb-3">1. Information We Collect</h2>
            <p><strong className="text-[var(--hs-ink)]">Account Information:</strong> When you create an account, we collect your name, email address, and company name. If you sign in via OAuth (Google, GitHub, Microsoft), we receive your public profile information from those providers.</p>
            <p className="mt-2"><strong className="text-[var(--hs-ink)]">Usage Data:</strong> We collect information about how you interact with the platform, including pages visited, features used, API scan counts, and assessment progress.</p>
            <p className="mt-2"><strong className="text-[var(--hs-ink)]">Compliance Data:</strong> When you use the AI compliance firewall, we process API request metadata (prompt hashes, risk classifications, detected entities). We never store raw prompt content in plaintext — quarantined items are encrypted with AES-256.</p>
            <p className="mt-2"><strong className="text-[var(--hs-ink)]">Payment Information:</strong> Payment processing is handled entirely by Stripe. We do not store credit card numbers. We retain Stripe customer IDs and subscription status.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li><strong className="text-[var(--hs-ink)]">Supabase:</strong> Database hosting and authentication</li>
              <li><strong className="text-[var(--hs-ink)]">Stripe:</strong> Payment processing</li>
              <li><strong className="text-[var(--hs-ink)]">Vercel:</strong> Application hosting</li>
              <li><strong className="text-[var(--hs-ink)]">OpenRouter:</strong> AI model inference (only when you use AI features)</li>
            </ul>
          ...
          <section>
            ...
            <p>For privacy-related inquiries, contact us at <a href="mailto:admin@houndshield.com" className="text-[var(--hs-steel-dark)] hover:underline">admin@houndshield.com</a>.</p>
          </section>
        </div>

        <div className="mt-12 pt-8 border-t border-[var(--hs-border-subtle)]">
          <Link href="/terms" className="text-sm text-[var(--hs-steel-dark)] hover:underline font-[var(--font-body)]">Read our Terms of Service &rarr;</Link>
        </div>
      </main>
      <FooterV3 />
    </div>
