  ...
  return (
    <div className="min-h-screen bg-[var(--hs-surface-0)]">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-32 pb-24">
        <h1 className="text-3xl font-semibold text-[var(--hs-ink)] mb-2" style={{ fontFamily: "var(--font-display)" }}>Terms of Service</h1>
        ...
        <div className="space-y-8 text-sm text-[var(--hs-ink-secondary)] leading-relaxed font-[var(--font-body)]">
          ...
          <section>
            ...
            <p>Questions about these terms? Contact us at <a href="mailto:info@houndshield.com" className="text-[var(--hs-steel-dark)] hover:underline">info@houndshield.com</a>. For enterprise legal inquiries, reach our team at <a href="mailto:admin@houndshield.com" className="text-[var(--hs-steel-dark)] hover:underline">admin@houndshield.com</a>.</p>
          </section>
        </div>

        <div className="mt-12 pt-8 border-t border-[var(--hs-border-subtle)]">
          <Link href="/privacy" className="text-sm text-[var(--hs-steel-dark)] hover:underline font-[var(--font-body)]">Read our Privacy Policy &rarr;</Link>
        </div>
      </main>
      <FooterV3 />
    </div>
