...
export function PixelOffice() {
    ...
    return (
        <div className="h-full flex flex-col bg-white rounded-xl border border-white/10 overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between px-5 py-3 border-b border-white/10 bg-white/[0.03] backdrop-blur-sm">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-500/20 to-brand-500/20 border border-purple-500/30 flex items-center justify-center">
            ...
            {/* Canvas Container */}
            <div className="flex-1 flex items-center justify-center p-4 overflow-auto bg-white/[0.03]">
                <div className="rounded-lg overflow-hidden border border-white/10 shadow-2xl shadow-purple-500/5">
                    <canvas
                        ref={canvasRef}
                        className="block"
            ...
            {/* Agent Status Bar */}
            <div className="border-t border-white/10 bg-white/[0.03] backdrop-blur-sm px-5 py-3">
                ...
                <div className="grid grid-cols-3 gap-2">
                    {agents.map((agent) => {
                        ...
                        return (
                            <div
                                key={agent.id}
                                className="flex items-center gap-2 px-2.5 py-1.5 rounded-md bg-white/[0.03] border border-white/10 hover:border-white/10 transition-all"
                            >
                                <div
