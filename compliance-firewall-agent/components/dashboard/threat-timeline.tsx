    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="glass-card p-3.5 text-center">
          ...
          <p className="text-[10px] text-slate-400 mt-0.5">Critical Threats</p>
        </div>
        <div className="glass-card p-3.5 text-center">
        ...
        <div className="glass-card p-3.5 text-center">
          <p className="text-xl font-bold text-brand-500">{avgProcessingTime}ms</p>
          <p className="text-[10px] text-slate-400 mt-0.5">Avg Scan Time</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="glass-card p-12 text-center">
          <ShieldCheck className="w-10 h-10 text-slate-300 dark:text-slate-300 mx-auto mb-3" />
          <p className="text-sm text-slate-400">No threat events yet</p>
          <p className="text-xs text-slate-300 dark:text-slate-300 mt-1">Events appear here when LLM requests are intercepted</p>
        </div>
      ) : (
          ...
          <div className="space-y-1">
            {events.map((event, index) => {
              ...
              return (
                <div
                  key={event.id}
                  className={`relative flex gap-3 py-3 px-3 rounded-lg hover:bg-white/5 transition-all ${
                ...
                >
                  ...
                  <div className="text-right flex-shrink-0">
                    <span className="text-[10px] text-slate-300 dark:text-slate-300 flex items-center gap-1">
