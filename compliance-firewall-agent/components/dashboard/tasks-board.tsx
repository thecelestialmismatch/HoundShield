...
const AGENTS = ['HoundShield', 'Analyst', 'Creator', 'Monitor', 'Specialist', 'Orchestrator'];
...
const SAMPLE_TASKS: Task[] = [
  ...
  { id: 't7', title: 'Daily security log aggregation', status: 'done', assignee: 'HoundShield', priority: 'medium', dueDate: '2026-02-27', type: 'recurring', tags: ['logging'] },
