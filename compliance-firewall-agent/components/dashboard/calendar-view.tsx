...
function generateSampleEvents(): CalEvent[] {
  ...
  return [
    ...
    { id: 'e5', title: 'Daily Log Aggregation', type: 'cron', date: dateStr(Math.min(today.getDate(), 28)), time: '00:30', agentName: 'HoundShield Prime' },
    ...
    { id: 'e10', title: 'Team Standup Sync', type: 'recurring', date: dateStr(Math.min(today.getDate(), 28)), time: '10:30', agentName: 'HoundShield Prime' },
