...
| `proxy/patterns/index.ts` | MIT | 40 CMMC/HIPAA/PII detection patterns |
...
See [PATTERNS.md](./PATTERNS.md) for the full list of 40 detection patterns with NIST control mappings.
